...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute top-0 left-0 w-96 h-96 bg-blue-500/10 blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="glass-dark border border-white/5 p-8 rounded-2xl w-full max-w-md z-10 flex flex-col gap-6 shadow-2xl">
        <div className="flex flex-col items-center text-center gap-2">
          ...
          <p className="text-sm text-gray-400">Solicitar acceso a la Central de Reportes</p>
        </div>
        ...
        {success ? (
          <div className="flex flex-col gap-4 text-center">
            <div className="bg-green-500/10 border border-green-500/20 text-green-400 text-sm p-4 rounded-xl">
              ¡Cuenta creada exitosamente! Revisa tu correo electrónico para confirmar la cuenta (si tienes habilitada la confirmación en Supabase) o inicia sesión ahora.
            </div>
            <Link href="/login" className="w-full bg-blue-600 hover:bg-blue-500 text-white font-semibold py-3 rounded-xl transition-all">
              Ir a Iniciar Sesión
            </Link>
          </div>
        ) : (
